...
\begin{tikzpicture}
	...
	\umlclass[y=-3, name=FP]{Front Panel}{Button: int \\ current-power: int \\ current-time: int \\ cook: bool}{send-command() \\ update-display(): d1, d2, d3, d4}
	\umlclass[x=-2, y=-7, name=PD]{Panel Display*}{ d1: int, d2: int \\ d3: int, d4: int }{ display( d1, d2, d3, d4 ) }
	\umlclass[x=4, y=-7, name=KP]{Keypad*}{button: int \\ button-pressed: bool }{pass-button(button): Button}
	\umlclass[x=8, y=-3, name=MHC]{Microwave Heater Coil*}{on: bool \\ power: int}{set-power()}
	\umlassoc[mult1=1, mult2=1]{MO}{MHC}
	\umlassoc[mult1=1, mult2=1]{MO}{FP}
	\umlassoc[mult1=1, mult2=1]{FP}{PD}
	\umlassoc[mult1=1, mult2=1]{FP}{KP}
\end{tikzpicture}
