...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	ENTRY		; Mark first instruction to execute
			; aa*(bb+cc)
start	LDR r4, =bb0	; Get address of bb0
	...
	MUL r2, r2, r0	; Compute aa0*(bb0+cc0), store to r2
			; (dd*35)
next	LDR r4, =dd0	; Get address of dd0
	LDR r0, [r4]	; Store value of dd0 in r0
	MUL r3, r0, #35	; Compute dd0*35, store to r3
			; aa*(bb+cc) - (dd*35)
final	SUB r2, r2, r3	; Final Computation: r2 = r2 - r3
			; store to address of zz
store	LDR r4, =zz0	; Get address of zz0
...
cc0 	DCD #3		; Declare value of cc0
dd0 	DCD #4		; Declare value of dd0
